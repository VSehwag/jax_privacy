...
from jax_privacy.src.training.diffusion_models import forward
from jax_privacy.src.training.diffusion_models import models
    ...
    def evaluate(
        ...
        *,
        ...
        metrics = jax.tree_map(
            np.asarray, self._eval_epoch(utils.get_first(rng)))
        metrics.update(
